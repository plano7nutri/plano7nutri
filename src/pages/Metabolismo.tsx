...
const Metabolismo = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center pb-8">
        <div className="container mx-auto">
          ...
          >
            ...
            {/* Apenas o botão de Cálculo Grátis permanece */}
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { icon: ClipboardList, title: "Preencha seus dados", description: "Idade, peso e nível de atividade. Simples e rápido." },
                { icon: Calculator, title: "Cálculo Metabólico", description: "Descobrimos seu TMB e GET com precisão científica." },
                { icon: MessageCircle, title: "Receba seu Cálculo na Hora", description: "Seu TMB, GET e macros calculados com precisão científica direto na tela, em segundos." }
              ].map((step, i) => (
                <motion.div
                  key={step.title}
                  initial={{ opacity: 0, y: 20 }}
      ...
      {/* Prova Social - Removido o botão de login daqui também para manter a consistência */}
      <div className="container mx-auto">
      ...
      {/* Testimonials sem a prop onLogin */}
      <Testimonials onStart={handleStart} />
    </div>
  );
};
