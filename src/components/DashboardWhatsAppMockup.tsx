...
const DashboardWhatsAppMockup = () => {
  ...
  useEffect(() => {
    ...
    if (scrollRef.current && !isPaused && msgIndex < messages.length) {
      scrollRef.current.scrollTo({
        top: scrollRef.current.scrollHeight,
        behavior: 'smooth'
      });
    }
  }, [currentMessages, isTyping, isPaused, msgIndex]);
...
export default DashboardWhatsAppMockup;